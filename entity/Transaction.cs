...
namespace DemoSession2.entity
{
    public class Transaction
    {
        ...
        public Transaction(string id, string createdAt, string senderAccountNumber, string receiverAccountNumber)
        {
            _id = id;
        ...
        public Transaction(string id, string createdAt, decimal amount, string content, string senderAccountNumber, string receiverAccountNumber)
        {
            _id = id;
            _createdAt = createdAt;
            _amount = amount;
